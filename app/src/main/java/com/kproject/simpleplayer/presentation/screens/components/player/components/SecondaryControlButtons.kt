...
fun SecondaryControlButtons(
    ...
    Row(
        ...
        val repeatModeIconResId = when (playerState.repeatMode) {
        ...
        CustomIconButton(
            ...
            onClick = {
                val newRepeatMode = RepeatMode.getNewRepeatMode(playerState.repeatMode)
        ...
        CustomIconButton(
            ...
            onClick = {
                onPlayerAction.invoke(PlayerAction.ChangeIsLandscapeMode(!playerState.isLandscapeMode))
            },
            reduceIconSize = true,
            modifier = Modifier
        )
        ...
        CustomIconButton(
            ...
            reduceIconSize = true,
            onClick = {
                val newResizeMode = ResizeMode.getNewResizeMode(playerState.resizeMode)
